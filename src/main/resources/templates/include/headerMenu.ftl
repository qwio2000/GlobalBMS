<div class="headerWrap">
	<div class="header">
		<input type="hidden" value="${menuFirstCode?default('') }" id="menuFirstCode"/>
		...
		<span class="utilInfo">Server Time : ${.now?string.medium_short} <br>System Week #${mainWeek[0] } [${mainWeek[1]} ~ ${mainWeek[2] }]</span>
